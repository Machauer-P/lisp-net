...
Changes over v310:
  ...
  1. No mixed precision — float32 throughout.  Avoids potential loss-scale
     instability, allowing a clean ablation against v310 to see if mixed
     precision causes reduced speed on cpu inference.
...
class PromptUNet:
    """
    Prompt U-Net v312 — pure Conv2D, no SE, float32 training.
